...
\begin{tabular}{ | r | l | }
  \hline 
  \multicolumn{2}{| c |}{Alfasäteilyn aiheuttama pulssitaajuus 5mm etäisyydeltä} \\ \hline
...
\begin{tabular}{ | r | l | }
  \hline 
  \multicolumn{2}{| c |}{Beetasäteilyn aiheuttama pulssitaajuus 5mm etäisyydeltä} \\ \hline
